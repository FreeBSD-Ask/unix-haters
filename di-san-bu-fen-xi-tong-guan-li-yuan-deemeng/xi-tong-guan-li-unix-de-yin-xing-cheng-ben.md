...
1985年，麻省理工学院媒体实验室有一台大型 VAX 系统，配备六个大磁盘驱动器和超过 64MB 的内存。他们注意到，磁盘 #2 上的“c”分区没有被使用，便允许 Unix 使用这个分区进行交换。
...
[^1]: Andy Tannenbaum，《UNIX 的政治》，华盛顿特区 USENIX 大会，1984年。（转载自《与 Unix 同行》中的引用，第13页）
